...
- `ghcr.io/lf-decentralized-trust-labs/fabricops-node-settlement:0.2.1`
- `ghcr.io/lf-decentralized-trust-labs/fabricops-go-settlement:0.2.1`
- `ghcr.io/lf-decentralized-trust-labs/fabricops-java-settlement:0.2.1`
